...
<head>
    ...
    <title>Zoo-Arcadia - Perroquets</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Pérroquets</h1>
              <p class="py-2">Arcadia recense actuellement 5 espèces de "Pérroquet".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/jungle/perroquet_ia.jpg" alt="Castor" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/jungle/Perroquets.jpg" class="card-img-top-animal z-0" alt="Harry">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/Perroquets1.jpg" class="card-img-top-animal z-0" alt="Apple_et_Pie">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Le couple Apple et Pie</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
                          <ul class="text-light">
                            <li><u>Santé</u> :  </li>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/perroquet2.jpg" class="card-img-top-animal z-0" alt="Biscuit">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Biscuit</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/perroquet3.jpg" class="card-img-top-animal z-0" alt="Booba">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Booba</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/perroquet4.jpg" class="card-img-top-animal z-0" alt="Joyeuse">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Le couple Joyeux & Joyeuse</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
                          <ul class="text-light">
                            <li><u>Santé</u> :  </li>
