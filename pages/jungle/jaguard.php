...
<head>
    ...
    <title>Zoo-Arcadia - Jaguards</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Jaguard</h1>
              <p class="py-2">Arcadia recense actuellement 4 espèces de "Jaguard".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/jungle/jaguard_ia.jpg" alt="jaguard" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/jungle/Jaguar.jpg" class="card-img-top-animal z-0" alt="Albator">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/Jaguard.jpg" class="card-img-top-animal z-0" alt="Bill">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Bill</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/jaguard1.jpg" class="card-img-top-animal z-0" alt="Puddles">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Puddles</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/jaguard2.jpg" class="card-img-top-animal z-0" alt="Waddles">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Waddles</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
