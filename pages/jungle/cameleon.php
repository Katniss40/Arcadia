...
<head>
    ...
    <title>Zoo-Arcadia - Cameleons</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Caméléon</h1>
              <p class="py-2">Arcadia recense actuellement 4 espèces de "Caméléon".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/jungle/cameleon_ia.jpg" alt="cameleon" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/jungle/Cameleon.jpg" class="card-img-top-animal z-0" alt="Haricot$3">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/cameleon1.jpg" class="card-img-top-animal z-0" alt="Huer$4">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Huer</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/cameleon2.jpg" class="card-img-top-animal z-0" alt="Camouflage">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Camouflage</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/jungle/cameleon3.jpg" class="card-img-top-animal z-0" alt="Bam_Bam">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Bam Bam</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
