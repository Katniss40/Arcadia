...
<head>
    ...
    <title>Zoo-Arcadia - Girafes</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Girafe</h1>
              <p class="py-2">Arcadia recense actuellement 5 espèces de "Girafe".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/savane/girafe_ia.jpg" alt="girafe" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/savane/girafe1.jpg" class="card-img-top-animal z-0" alt="Achille">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/girafe3.jpg" class="card-img-top-animal z-0" alt="Boggy">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Boggy</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/girafe4.jpg" class="card-img-top-animal z-0" alt="Drake">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Drake</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/girafe5.jpg" class="card-img-top-animal z-0" alt="Gato">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Gato</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/girafe6.jpg" class="card-img-top-animal z-0" alt="Iggy">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Iggy</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
