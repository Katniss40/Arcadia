...
<head>
    ...
    <title>Zoo-Arcadia - Zebres</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Zèbres</h1>
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/savane/zebre_ia.jpg" alt="zebres" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/savane/zebre1.jpg" class="card-img-top-animal z-0" alt="couple">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/zebres_bebe.jpg" class="card-img-top-animal z-0" alt="Bebe">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Zephi & son Bébé</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
                        <ul class="text-light">
                          <li><u>Santé</u> : </li>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/zebre2.jpg" class="card-img-top-animal z-0" alt="Solitaire">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Solitaire</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
