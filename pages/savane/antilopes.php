...
<head>
    ...
    <title>Zoo-Arcadia - Antilopes</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Antilopes</h1>
              <p class="py-2">Arcadia recense actuellement 5 espèces de "Antilopes".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/savane/antilope_ia.jpg" alt="antilope" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/savane/antilope1.jpg" class="card-img-top-animal z-0" alt="Indy">
          ...
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/antilope2.jpg" class="card-img-top-animal z-0" alt="Grignotine">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Grignotine</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/antilope3.jpg" class="card-img-top-animal z-0" alt="Marina">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Marina</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/antilope4.jpg" class="card-img-top-animal z-0" alt="Delta">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Delta</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/savane/antilope5.jpg" class="card-img-top-animal z-0" alt="Alaqua">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Alaqua</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
