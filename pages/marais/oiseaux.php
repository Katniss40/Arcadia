...
<head>
    ...
    <title>Zoo-Arcadia - OIseaux</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">La volière aux Oiseaux</h1>
              <p class="py-2">Arcadia recense actuellement 4 espèces d' "Oiseaux".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/marais/oiseaux_ia.jpg" alt="oiseaux" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/marais/echassier.jpg" class="card-img-top-animal z-0" alt="Echasse">
          ...
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/becassine.jpg" class="card-img-top-animal z-0" alt="Becassine">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Becassine</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
          ...
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/Oiseaux.jpg" class="card-img-top-animal z-0" alt="Martin">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Martin</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
          ...
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/heron1.jpg" class="card-img-top-animal z-0" alt="Heron">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Herone</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
