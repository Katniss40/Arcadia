...
try {
  ...
  // Si ça fonctionne, on affiche un message
  echo "La connexion BDD réussie";
} catch(PDOException $e) {
  // Si ça ne fonctionne pas, on affiche un message d'erreur
  echo "La connexion BDD échoué: " . $e->getMessage();
}

// On sélectionne le champs commentaires, typeN, quantite, visite, remarques, repas de la table animaux
$sql = 'SELECT commentaires, typeN, quantite, visite, remarques, repas FROM animaux';
...
<head>
    ...
    <title>Zoo-Arcadia - Castors</title>
  ...
  <section id="services_list" class="section">         
    ...
    <div class="row bg-arc-mint-green text-light mt-3">            
      <div class="offset-lg-1 col-lg-6">                       
        <div>
          <h1 class="text-light text-center pb-2">Castor</h1>
                <p class="py-2">Arcadia recense actuellement 5 espèces de "Castor".
      ...
      <div class="col-lg-4 d-flex justify-content-center text-align-center">
        <img src="/images/marais/castor_ia.jpg" alt="Castor" class="service-img img-fluid">
      </div>
    </div>       
          ...
          <div class="row g-0 px-2">
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/castor3.jpg" class="card-img-top-animal z-1" alt="Crush">
              ...
              <div class="col-12 col-lg-4 pb-3 pe-md-2">
                <div class="card card-habitat">
                  <img src="/images/marais/Castor2.jpg" class="card-img-top-animal z-0" alt="Craig">
                    <div class="card-body bg-light d-flex flex-column">
                      <h2>Craig</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
              ...
              <div class="col-12 col-lg-4 pb-3 pe-md-2">
                <div class="card card-habitat">
                  <img src="/images/marais/Castor1.jpg" class="card-img-top-animal z-0" alt="Maverick">
                    <div class="card-body bg-light d-flex flex-column">
                      <h2>Maverick</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
              ...
              <div class="col-12 col-lg-4 pb-3 pe-md-2">
                <div class="card card-habitat">
                  <img src="/images/marais/Castor.jpg" class="card-img-top-animal z-0" alt="Oxbow">
                    <div class="card-body bg-light d-flex flex-column">
                      <h2>Oxbow</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
              ...
              <div class="col-12 col-lg-4 pb-3 pe-md-2">
                <div class="card card-habitat">
                  <img src="/images/marais/castor4.jpg" class="card-img-top-animal z-0" alt="Bayou">
                    <div class="card-body bg-light d-flex flex-column">
                      <h2>Bayou</h2>                            
                      <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                        <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
