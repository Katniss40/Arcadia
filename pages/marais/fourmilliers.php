...
<head>
    ...
    <title>Zoo-Arcadia - Fourmiliers</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">Fourmiliers</h1>
              <p class="py-2">Arcadia recense actuellement 3 espèces de "Fourmiliers".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/marais/fourmilier_accueil.jpg" alt="fourmiliers" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/marais/foumilier1.jpg" class="card-img-top-animal z-0" alt="Brutus">
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/fourmilier2.jpg" class="card-img-top-animal z-0" alt="Nilo">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Nilo</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
            ...
            <div class="col-12 col-lg-4 pb-3 pe-md-2">
              <div class="card card-habitat">
                <img src="/images/marais/fourmilier3.jpg" class="card-img-top-animal z-0" alt="Spike">
                  <div class="card-body bg-light d-flex flex-column">
                    <h2>Spike</h2>                            
                    <div class="bg-arc-secondary rounded-5 mt-3 p-3">
                      <h3 class="text-light"><i class="fa-solid fa-user-doctor"></i> Le dernier avis du vétérinaire</h3>
