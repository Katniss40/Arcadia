...
<head>
    ...
    <title>Zoo-Arcadia - Tritons</title>
...
<section id="services_list" class="section">         
  ...
  <div class="row bg-arc-mint-green text-light mt-3">            
    <div class="offset-lg-1 col-lg-6">                       
      <div>
        <h1 class="text-light text-center pb-2">tritons</h1>
              <p class="py-2">Arcadia recense actuellement 1 espèce de "Triton".
    ...
    <div class="col-lg-4 d-flex justify-content-center text-align-center">
      <img src="/images/marais/triton_ia.jpg" alt="triton" class="service-img img-fluid">
    </div>
  </div>       
        ...
        <div class="row g-0 px-2">
          <div class="col-12 col-lg-4 pb-3 pe-md-2">
            <div class="card card-habitat">
              <img src="/images/marais/triton.jpg" class="card-img-top-animal z-0" alt="Electra">
                  <h2>Electra</h2>
