...
<head>
    ...
    <title>Zoo-Arcadia - Edition des animaux</title>
    ...
    <div class="container mt-5">
        ...
        <form action="/pages/controleurs/gestion_animal.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id_name" name="id_name" value="" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="espece" name="espece" value="" required>
            </div>
            <div class="form-group">
                <label for="age">Âge :</label>
                <div class="input-group">
                    <input type="text" class="form-control" id="age" name="age" value="" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="poids" name="poids" value="" required>
                    <div class="input-group-append">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="typeN" name="typeN" value="" required>
            </div>
            <div class="form-group">
                <label for="repas">Dernier repas :</label>
                <input type="datetime-local" class="form-control" id="repas" name="repas" value="" required>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control" id="nourriture" name="nourriture" required>
